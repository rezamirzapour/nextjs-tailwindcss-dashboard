        ...
        <form>
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                type="email"
                placeholder={messages.signIn.email_placeholder}
          ...
          <div className="mb-6">
            <label className="mb-2.5 block font-medium text-black dark:text-white">
              {messages.signIn["re-type"]} {messages.signIn.password}
            </label>
            <div className="relative">
              <input
                type="password"
                placeholder={messages.signIn.password_placeholder}
